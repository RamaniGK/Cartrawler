...
public class CarObjectInput {
	public static final HashSet<CarResult> CARS;;
	static {
		CARS = new HashSet<>();
		...
		CARS.add(new CarResult("BMW 2 Series Gran Tourer Diesel", "NIZA", "JVAD", 146.62d,
		...
		CARS.add(
				new CarResult("Mercedes Vito Traveliner", "CENTAURO", "SVMR", 163.73d, CarResult.FuelPolicy.FULLEMPTY));
		...
		CARS.add(
				new CarResult("Mercedes Vito Traveliner", "CENTAURO", "SVMR", 168.59d, CarResult.FuelPolicy.FULLEMPTY));
		...
		CARS.add(
				new CarResult("BMW 4 Series Convertible", "MARBESOL", "RTAV", 189.85d, CarResult.FuelPolicy.FULLEMPTY));
		CARS.add(new CarResult("Renault Megane Convertible", "MARBESOL", "CTMR", 59.22d,
				CarResult.FuelPolicy.FULLEMPTY));
		...
		CARS.add(
				new CarResult("Mercedes Vito Traveliner", "MARBESOL", "SVMR", 108.04d, CarResult.FuelPolicy.FULLEMPTY));
		...
		CARS.add(new CarResult("Renault Megane Convertible", "MARBESOL", "CTMR", 204.47d,
				CarResult.FuelPolicy.FULLFULL));
		...
		CARS.add(new CarResult("Mercedes Vito Traveliner", "ENTERPRISE", "SVMR", 579.11d,
				CarResult.FuelPolicy.FULLFULL));
